...
/** Exclude Prisma generated runtime from source-map-loader to avoid missing .map warning */
...
module.exports = {
  output: {
    path: join(__dirname, '../../dist/apps/loan-service'),
    clean: true,
